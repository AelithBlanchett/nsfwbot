...
sexual.push(
    {
        ...
        lustPenalty: "1",
        damageLust: "2",
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && currentFight.currentHold.aliasId == 4",
        conditionsText: "The target must be in a forced face fucking.",
        onSuccess: "",
        onSuccessText: "",
        onFailure: "",
        onFailureText: "",
...
sexual.push(
    {
        ...
        damageLust: "3",
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && (currentFight.currentHold.aliasId == 2 || currentFight.currentHold.aliasId == 5)",
        conditionsText: "Opponent must be in either \"Forced Fingering\" or \"Forced Cock Stroking\" to use this move. ",
        onSuccess: "",
        onSuccessText: "",
        onFailure: "",
        onFailureText: "",
...
sexual.push(
    {
        ...
        damageLust: 2,
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && currentFight.currentHold.aliasId == 3",
        conditionsText: "Opponent must be in \"Forced Cock Sucking\" to use this move.",
        onSuccess: "",
        onSuccessText: "",
        onFailure: "",
        onFailureText: "",
...
sexual.push(
    {
        ...
        damageLust: 3,
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && (currentFight.currentHold.aliasId == 5 || currentFight.currentHold.aliasId == 7)",
        conditionsText: "Opponent must be in \"Forced Cock Sucking\" or \"Forced Licking\" to use this move.",
        onSuccess: "",
        onSuccessText: "",
        onFailure: "",
        onFailureText: "",
...
sexual.push(
    {
        ...
        description: "L-Lewd!~♥",
        damageLust: 3,
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && currentFight.currentHold.aliasId == 5",
        conditionsText: "Opponent must be in \"Forced Fingering\" to use this move.",
        onSuccess: "",
        onSuccessText: "",
        onFailure: "",
        onFailureText: "",

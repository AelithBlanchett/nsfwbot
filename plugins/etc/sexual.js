...
sexual.push(
    {
        ...
        lustPenalty: "1",
        damageLust: "2",
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && currentFight.currentHold.id == 4",
...
sexual.push(
    {
        ...
        damageLust: "3",
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && (currentFight.currentHold.id == 2 || currentFight.currentHold.id == 5)",
...
sexual.push(
    {
        ...
        damageLust: 2,
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && currentFight.currentHold.id == 3",
...
sexual.push(
    {
        ...
        damageLust: 3,
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && (currentFight.currentHold.id == 5 || currentFight.currentHold.id == 7)",
...
sexual.push(
    {
        ...
        description: "L-Lewd!~♥",
        damageLust: 3,
        conditions: "isInHold(defender) && currentFight.currentHold.type == 'sexual' && currentFight.currentHold.id == 5",
